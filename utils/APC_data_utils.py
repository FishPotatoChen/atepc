...
class APCProcessor(DataProcessor):
    ...
    def get_test_examples(self, data_dir):
        ...
        if 'car' in data_dir:
            ...
            return self._create_examples(self._read_tsv(os.path.join(data_dir, "phone.atepc.test.dat")), "test")
        elif 'camera' in data_dir:
            return self._create_examples(
...
def convert_examples_to_apc_features(examples, label_list, max_seq_length, tokenizer):
